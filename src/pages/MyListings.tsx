  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link
          to="/create-listing"
          className="mt-6 sm:mt-0 inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#e24a37] to-red-500 text-white font-semibold rounded-2xl hover:from-red-600 hover:to-red-600 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
        >
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-12 pr-4 py-3 w-full sm:w-80 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#e24a37] focus:border-[#e24a37] transition-colors bg-gray-50 focus:bg-white"
              />
            </div>
            ...
            <select
              ...
              className="px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#e24a37] focus:border-[#e24a37] bg-gray-50 focus:bg-white transition-colors"
            >
          ...
          <div className="flex items-center space-x-2 bg-gray-100 rounded-xl p-1">
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${viewMode === 'grid' ? 'bg-white text-[#e24a37] shadow-sm' : 'text-gray-400 hover:text-gray-600'}`}
            >
              <Grid3X3 className="h-5 w-5" />
            </button>
            <button
              onClick={() => setViewMode('list')}
              className={`p-2 rounded-lg transition-colors ${viewMode === 'list' ? 'bg-white text-[#e24a37] shadow-sm' : 'text-gray-400 hover:text-gray-600'}`}
            >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center space-x-1">
                      <Link
                        ...
                        className="p-2 text-gray-400 hover:text-[#e24a37] transition-colors rounded-full hover:bg-red-50"
                      >
