...
const Dashboard: React.FC = () => {
  ...
  const stats = [
    ...
    { name: t('dashboard.stats.favorites'), value: '45', icon: Heart, color: 'from-pink-500 to-pink-600', change: '+7%' },
  ];
  ...
  return (
    <div className="space-y-8">
      {/* Welcome Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-pink-500 via-red-500 to-pink-600 rounded-3xl shadow-xl">
        ...
        <div className="relative px-8 py-12">
          <div className="flex items-center justify-between">
            ...
            <Link
              to="/create-listing"
              className="hidden lg:inline-flex items-center px-6 py-3 bg-white text-pink-600 font-semibold rounded-2xl hover:bg-pink-50 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
